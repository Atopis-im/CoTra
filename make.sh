...
# RUN_OUTPUT="/home/team/alg_mathlib/c30061081/gist_1M_960/cotra_8node_index"

# 临时启用LAT（编译时打开，输出avg_lat）
# --lat
bash scripts/arm_roce_8node.sh build \
  ...
  --output-dir     /home/team/alg_mathlib/c30061081/dataset/laion100m/cotra_8node_index_512d_R48_L500 \
